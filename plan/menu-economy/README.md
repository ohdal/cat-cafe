...
| --- | --- |
| 1F (Lv1) | 아메리카노 30 · 카페라떼 36 · 바닐라 라떼 42 · 고양이 간식 30 · 고양이 장난감 54 |
| 2F (Lv2) | 자스민티 54 · 캐모마일티 60 · 얼그레이티 66 |
| 3F (Lv3) | 레몬 에이드 78 · 자몽 에이드 84 · 청포도 에이드 90 |
| 4F (Lv4) | 초코 라떼 108 · 말차 라떼 120 · 아이스티 132 |
| 5F (Lv5) | 크림 아인슈페너 156 · 솔티드 카라멜 라떼 174 · 헤이즐넛 모카 192 |
| 6F (Lv6) | 냥카라멜 프라페 222 · 냥자바칩 프라페 246 · 냥말차 프라페 270 |
| 7F (Lv7) | 딸기 프라페 315 · 발바닥 쿠키 프라페 354 · 우주냥 티라미수 프라페 390 |

### 메뉴 수익/업그레이드 비용 곡선 (예: 아메리카노 base=30)
...
- [ ] 시작 수치 검증: 카페 Lv.1, 5메뉴 전부 L0 → 약 **192 G/h ≈ 0.053 G/s**
